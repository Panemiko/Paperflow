...
export function Methodology({ dict, items }: MethodologyProps) {
  ...
  return (
    <div className="w-full">
      <div className="relative w-full min-h-[120px] md:h-48 flex items-center justify-center overflow-hidden bg-background/50 border-y border-border backdrop-blur-sm">
