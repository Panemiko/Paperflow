...
import type { TDiscussion } from "../discussion/block-discussion";
...
import {
  ...
  useFakeUserInfo,
} from "../discussion/block-discussion";
import { Editor, EditorContainer } from "../editor";
import { EmojiInputElement } from "../emoji/emoji-input-element";
  ...
  const onAddComment = React.useCallback(async () => {
    ...
    if (discussionId) {
      ...
      const updatedDiscussions = discussions
        .filter((d: { id: string }) => d.id !== discussionId)
